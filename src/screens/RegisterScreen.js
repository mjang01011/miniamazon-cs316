...
//get name, email, password
  ...
  const [isSeller, setSeller] = useState(undefined);
  ...
  const submitHandler = (e) => {
    ...
    dispatch(register(fullName, username, email, password, isSeller)); //dispatch register action
  }
  //registration form
    ...
    <form onSubmit={submitHandler} >
      <ul className="form-container">
        ...
        <li>
          ...
          <input type="checkbox" id="isSeller" name="isSeller" checked={isSeller} onChange={(e) => setSeller(e.target.checked)}>
          </input>
        </li>
        <li>
